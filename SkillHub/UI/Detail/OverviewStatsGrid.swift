...
struct OverviewStatsGrid: View {
    ...
    var body: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 160), spacing: 16)], spacing: 16) {
            ...
            OverviewStatCard(title: "重复安装", value: stats.duplicateSkills, symbolName: "square.on.square")
            OverviewStatCard(title: "符号链接", value: stats.symlinkInstalls, symbolName: "link")
        }
    }
}
